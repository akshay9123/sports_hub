...
import { createPriceCategory, deletePriceCategory, getAllPriceCategories, getPriceCategoryByCode, getSpecificPriceCategory, updatePriceCategory } from "../controllers/priceCategory.controller.js";

const router = express.Router();


// ROUTES TO CREATE THE PRICE CATEGORY
router.post("/create_price_category", createPriceCategory);
